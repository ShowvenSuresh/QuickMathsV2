 ...
 * @author Lenovo
 */
public class LearningTheme extends javax.swing.JFrame {
private boolean isPlaying = false;
private Clip clip;
    /**
     * Creates new form LearningMode
     */
    public LearningTheme() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LearningTheme.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LearningTheme().setVisible(true);
            }
        });
    }
