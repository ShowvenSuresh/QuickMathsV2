 ...
 * @author Lenovo
 */
public class LearningMode extends javax.swing.JFrame {
...
private Clip clip;
    ...
    private void jPanel11MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel11MouseClicked
        // TODO add your handling code here:
        LearningTheme jf1 = new LearningTheme();
        jf1.show();
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LearningMode.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LearningMode().setVisible(true);
            }
        });
    }
